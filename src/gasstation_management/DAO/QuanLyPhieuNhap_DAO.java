...
public class QuanLyPhieuNhap_DAO {
    ...
    public ArrayList getALLPhieuNhap() {
        ...
        try {
            PreparedStatement stm = db.getConnection().prepareStatement("select phieunhap.mapn,phieunhap.masp,phieunhap.soluong,phieunhap.ngaytao,phieunhap.trangthaithanhtoan,phieunhap.tongtien from phieunhap");
            rs = db.sqlQry(stm);
            if (rs != null) {
                while (rs.next()) {
...
// Lấy thông tin chi tiết của phiếu nhập
    ...
    public ArrayList getDetailPhieuNhap(String mapn) {
        ...
        try {
            PreparedStatement stm = db.getConnection().prepareStatement("select phieunhap.mapn,phieunhap.masp,phieunhap.mancc,nhanvien.tennv ,sanpham.tensp,phieunhap.soluong,phieunhap.ngaytao,phieunhap.trangthaithanhtoan,phieunhap.gianhap, phieunhap.tongtien from phieunhap, sanpham,nhanvien where phieunhap.masp=sanpham.masp and phieunhap.manv=nhanvien.manv and phieunhap.mapn=?");
